...
INSERT INTO images (id, visibility, author_id) VALUES (1, 'PUBLIC', 1);
INSERT INTO images (id, visibility, author_id) VALUES (2, 'PRIVATE', 2);

ALTER TABLE images ALTER COLUMN id RESTART WITH 3;

INSERT INTO comment (id, body, created_at, author_id, image_id) VALUES (1, 'First comment', '2024-09-30 10:00:00', 1, 1);
INSERT INTO comment (id, body, created_at, author_id, image_id) VALUES (2, 'Second comment', '2024-09-30 11:00:00', 1, 1);
INSERT INTO comment (id, body, created_at, author_id, image_id) VALUES (3, 'Authors comment', '2024-09-30 12:00:00', 2, 1);
