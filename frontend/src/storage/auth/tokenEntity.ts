import { AUTH_TOKEN_FIELD, AUTH_TOKEN_NULL_VALUE } from '@/constants/authConstants'
...
export const TokenManagementEntity: StorageManagementEntity<string, typeof AUTH_TOKEN_FIELD> = {
