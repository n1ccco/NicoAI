import { AUTH_USER_FIELD, AUTH_USER_NULL_VALUE } from '@/constants/authConstants'
...
export const UserManagementEntity: StorageManagementEntity<User, typeof AUTH_USER_FIELD> = {
    key: AUTH_USER_FIELD,
